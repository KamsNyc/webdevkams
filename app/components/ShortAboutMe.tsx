...
function ShortAboutMe() {
    return (
      <section className="w-full px-4 md:px-[64px] 2xl:px-[256px] ">
        {/* FLEX CONTAINER */}
        <div id='about' className="block md:flex items-center justify-between my-[64px] md:my-[96px] lg:my-0 h-full md:h-[471px] gap-16">
          ...
          <div className="w-full md:max-w-[300px] flex flex-col gap-y-6 lg:gap-y-12 justify-center py-2 mt-[16px] lg:mt-0">
            ...
            {/* BUTTON */}
            <button className="px-[24px] py-[14px] lg:px-[32px] lg:py-[20px] rounded-[48px] flex items-center justify-center gap-4 w-[202px] border-[1.6px] border-[#1F1F1E]/20 hover:border-[#1F1F1E]/40 duration-200 ease-in-out text-black font-bold text-[14px]">CONTACT ME <span><Image src={'/RightArrow.svg'} alt='' width={25} height={20} /></span></button>
          </div>
        </div>
      </section>
    );
